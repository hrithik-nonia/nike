      ...
      <div className="  w-full ">
        <div className=" p-6">
          <div className="flex items-center justify-between mb-5">
            <h2 className="text-xl font-bold text-white">Recomended</h2>
            <div className="flex items-center gap-2">
              {/* <ChevronBtn dir="left" onClick={() => scroll("left")} />
              <ChevronBtn dir="right" onClick={() => scroll("right")} /> */}
            </div>
          </div>

          {/* Scrollable container — scrollbar hide */}
          <div
            ref={scrollRef}
